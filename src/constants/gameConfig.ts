...
export const LEFT_COLUMN_VALUES_CHILDREN = [5, 10,15, 20, 25, 30, 40, 50, 60, 75, 90]
export const RIGHT_COLUMN_VALUES_CHILDREN = [100, 120, 150, 175, 200, 250, 300, 400, 500, 750, 1000]
export const ALL_VALUES = [...LEFT_COLUMN_VALUES, ...RIGHT_COLUMN_VALUES]
export const ALL_VALUES_CHILDREN = [...LEFT_COLUMN_VALUES_CHILDREN, ...RIGHT_COLUMN_VALUES_CHILDREN]
